...
def score_chunk(chunk, lookups, rsid_lookup, af_lookup, reclass_model, reclass_feature_cols,
    ...
    # real ANNOVAR AF/exonic-func, joined by VariationID, replaces the earlier
    # 0.0/"unknown" imputation used before ANNOVAR was set up
...
if __name__ == "__main__":
    ...
    for i in range(n_chunks):
        ...
        scored = score_chunk(chunk, lookups, rsid_lookup, af_lookup, reclass_model, reclass_feature_cols,
                              direction_models, direction_feature_cols, cox_model, survival_feature_cols)
        # user-facing rename: VariationID -> ClinvarID (internal join key upstream stays
        # VariationID, matching ClinVar's own field name; only the final output is renamed)
